	...
	<section class='content'>
		<div class='box box-default'>
			<div class="box box-primary">
				...
				<form action='<?php echo base_url().'admin/insertPeserta';?>' method='post' id='inputPeserta'>
				...
				if($show=='true'){?>
					<div class="box-body" >
						...
						<table class="table table-bordered table-striped table-hover dataTable" id="tabel_input_peserta">
							<thead>
								<tr>
									<th>Proses</th>
									<th>NIM</th>
							...
							<tbody>
								...
								?>
								<tr>
									<td align="center"><input type="checkbox" id="cekbox" class="minimal" name='mhs_id[]' value='<?php echo $row->mhs_id;?>' onChange='countCheckbox'></td>
