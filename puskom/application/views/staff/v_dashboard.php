    ...
    <div class="row">
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
          ...
          <a href="#" class="small-box-footer today">Lihat Jadwal <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer thismonth">Lihat Jadwal <i class="fa fa-arrow-circle-right"></i></a></i></a>
        </div>
      </div>
      <!-- ./col -->
    </div>
