<!-- Jquery Core Js -->
    ...
    <script type="text/javascript">
        ...
        $('#Modal_Edit #btn_update').on('click',function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    if (password_edit != "") {
                        alert('Password baru = ' +password_edit);
                    }
    ...
    <script type="text/javascript">
        ...
        function validPass(){
            ...
            $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('Admin/validPassword')?>",
                    dataType : "html",
    ...
    <script type="text/javascript">
        ...
        function status_log_aktif(){
            ...
            // var token_user = <?php //echo $this->input->cookie('token_user'); ?>;
            $.ajax({
                type : "ajax",
                url  : "<?php echo base_url('admin/updateStatusLog')?>",
                dataType : "html",
